...
DEFINE_string(config_file, ROOT_DIR "config/avia.yaml", "path to config file");
DEFINE_string(bag_file, "/home/xiang/Data/dataset/fast_lio2/avia/2020-09-16-quick-shack.bag", "path to the ros bag");
DEFINE_string(time_log_file, ROOT_DIR "Log/time.log", "path to time log file");
DEFINE_string(traj_log_file, ROOT_DIR "Log/traj.txt", "path to traj log file");
